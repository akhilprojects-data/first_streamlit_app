...
#New Section to display fruityvice display responce
...
#Add a button to insert the data  
...
#don't run snything past while we run trouble shoot
streamlit.stop()
